...
export default {
  ...
  render(h) {
    return h('div', {
      ...
      h('div', {
        attrs: { class: 'cs-theme-header-menu__content', flex: '', 'flex-box': '1' },
        ref: 'content'
      }, [
        h('div', {
          attrs: { class: 'cs-theme-header-menu__scroll', 'flex-box': '0' },
      ...
      ...this.isScroll ? [
        h('div', {
          attrs: { class: 'cs-theme-header-menu__prev', flex: 'main:center cross:center', 'flex-box': '0' },
        ...
        h('div', {
          attrs: { class: 'cs-theme-header-menu__next', flex: 'main:center cross:center', 'flex-box': '0' },
